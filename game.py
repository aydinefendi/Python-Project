...
def refill_hands(player_hand: List[Card], computer_hand: List[Card], draw_stack: List[Card]) -> tuple[List[Card], List[Card], List[Card]]:
    """
    ...
    Returns:
        tuple: Updated draw_stack, computer_hand and player_hand.
    """
    ...
    return player_hand, computer_hand, draw_stack
